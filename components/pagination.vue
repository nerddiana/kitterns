  ...
  <div class="flex flex-col items-center my-12">
    <div class="flex text-gray-700">
      ...
      <div class="flex h-12 font-medium rounded-full bg-gray-200">
        ...
        <div
          class="w-12 md:flex justify-center items-center hidden cursor-pointer leading-5 transition duration-150 ease-in rounded-full bg-purple text-white"
        >
          2
        </div>
        <div
        ...
        <div
          class="w-12 h-12 md:hidden flex justify-center items-center cursor-pointer leading-5 transition duration-150 ease-in rounded-full bg-purple text-white"
        >
          2
        </div>
      </div>
